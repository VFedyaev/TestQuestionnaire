...
{
    public abstract class BaseQueryService<TEntity, TModel, TSortType> : BaseService, IBaseQueryService<TEntity, TModel, TSortType> where TEntity : class, IEntityBase, new()
    {
        public BaseQueryService(IUnitOfWork uow, IMapper mapper) : base(uow, mapper) { }
